        ...
        <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
            ...
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">New User Information
                    ...
                    <button type="submit" name="submit" class="btn btn-sm btn-light float-right mr-2" style="font-size: 12px;"><i class="mdi mdi-account-plus mr-2"></i> Save account</button>
                </h4>
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password2" class="form-control" id="inputpasswordConfirm" placeholder="Enter password">
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="inputProfilePicture">Insert Image</label>
