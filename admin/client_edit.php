            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
                ...
                <form method="post" action="">
                    ...
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">Edit Client Information
                        ...
                        <button type="submit" name="submit" class="btn btn-sm btn-light float-right mr-2" style="font-size: 12px;"><i class="mdi mdi-account-plus mr-2"></i> Edit Customer</button>
                    </h4>
                    <div class="form-row">
