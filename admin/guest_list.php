...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            ...
            <a class="btn btn-sm btn-light mr-2 " style="font-size: 12px;" href="guest_list.php?<?= $links; ?>"><i class="mdi mdi-account-plus mr-2"></i> Master List Guest</a>
...
<div class="text-right mr-2 mb-3">
    <a class="btn btn-sm btn-light mr-2" style="font-size: 12px;" href="guest_add.php?<?= $links; ?>"><i class="mdi mdi-account-plus mr-2"></i> New Guest</a>
</div>
<table id="guest_list" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" style="background: white;padding: 0 5px;">
