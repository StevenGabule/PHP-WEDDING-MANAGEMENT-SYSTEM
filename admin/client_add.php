            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
                ...
                <form action="client_add.php" method="post">
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">New Client Information
                        ...
                        <button type="submit" name="submit" class="btn btn-sm btn-light float-right mr-2" style="font-size: 12px;"><i class="mdi mdi-account-plus mr-2"></i> Save Customer</button>
                    </h4>
                    <div class="form-row">
                        <?php
                            if ($session->message()) {
                    ...
                    <div class="form-row form-group">
                        ...
                        <div class="input-group col-md-6">
                            <select class="form-control" id="wedding_type" name="wedding_type">
                                ...
                                <option value="3">Timeless</option>
                                <option value="4">Timeless Gold</option>
                                <option value="5">Timeless Silver</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" id="inputOrganizer" name="organizer_id">
                                <option value="1">Mommy Ambol</option>
                                <option value="2">Someone 1</option>
                                <option value="3">someone 2</option>
                            </select>
