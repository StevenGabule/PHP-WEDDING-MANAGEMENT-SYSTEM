...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h4 class="h4 mt-4">Account Management</h4>
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            <a class="btn btn-sm btn-light" style="font-size: 12px;" href="users_add.php"><i class="mdi mdi-account-plus mr-2"></i> New Account</a>
        </div>
    </div>
</div>
<?php
...
<table id="example" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" style="background: white;padding: 0 5px;">
    ...
    <?php foreach ($users as $user) : ?>
        ...
        <tr>
            ...
            <td class="special"> <?= $user->designation; ?></td>
