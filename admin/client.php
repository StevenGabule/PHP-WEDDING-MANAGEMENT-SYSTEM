...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h6 class="h6 mt-4 ml-3">Pending Client</h6>
    <div class="btn-toolbar mb-md-0">
        <div class="btn-group mr-2">
            <a class="btn btn-sm btn-light" style="font-size: 12px;" href="client_add.php"><i class="mdi mdi-account-plus mr-2"></i> New Client</a>
        </div>
    </div>
</div>
<?php
...
<table id="pending" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" style="background: white;padding: 0 5px;">
    ...
    <?php foreach ($booking as $bookWedding) : ?>
        ...
        <tr>
            ...
            <td class="special"><?= $bookWedding->firstname . ' ' . $bookWedding->lastname;?></td>
          
            <td class="special">
                <?= (empty($bookWedding->bride)) ?  'Need to fill' :  $bookWedding->bride; ?>
            </td>
            
            <td class="special"><?= (empty($bookWedding->groom)) ?  'Need to fill' :  $bookWedding->groom; ?></td>
            
            <td class="special"><?= $bookWedding->user_email; ?></td>
            
            <td class="special"> <?= $bookWedding->phone; ?></td>

            <td class="special"><?= (empty($bookWedding->wedding_date)) ?  'N/A' :  $bookWedding->wedding_date; ?></td>
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h6 class="h6 mt-4 ml-3">Confirmed Client</h6>
</div>
<table id="confirmed" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" style="background: white;padding: 0 5px;">
    ...
    <?php foreach ($booking_confirm as $booking_confirm_row) : ?>
        ...
        <tr>
            ...
            <td class="special"><?= $booking_confirm_row->firstname . ' ' . $booking_confirm_row->lastname;?></td>
          
            <td class="special">
                <?= (empty($booking_confirm_row->bride)) ?  'Need to fill' :  $booking_confirm_row->bride; ?>
            </td>
            
            <td class="special"><?= (empty($booking_confirm_row->groom)) ?  'Need to fill' :  $booking_confirm_row->groom; ?></td>
            
            <td class="special"><?= $booking_confirm_row->user_email; ?></td>
            
            <td class="special"> <?= $booking_confirm_row->phone; ?></td>
            
            <td class="special"><?= (empty($booking_confirm_row->wedding_date)) ?  'N/A' :  $booking_confirm_row->wedding_date; ?></td>
