...
<head>
    ...
    <title>A MOMMY AMBOL - Wedding Planner</title>
     ...
     <div class="row">
        <div class="col-md-12 p-0" style="margin-bottom: 20px;"> <!-- border:1px solid rgba(0,0,0,.125) -->
            ...
            <div class="float-left" style="width: 47%;"> 
                <ul class="list-group">
                    <li class="list-group-item active" style="padding-top: 12px;"><h6 class="h6 text-center"><?= $category_row->wedding_type; ?> Package Wedding - Price: ₱ <?= number_format($category_row->price,2); ?></h6></li>
